...
Assignment operators (`=`, `+=`, etc) can be used to change the current **base** value of any Stat. To view the base value (separated from any bonuses), you can use the `@` prefix when evaluating any stat.
